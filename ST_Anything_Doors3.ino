...
#define PIN_RELAY_FRONTGARAGE_DOOR    7
#define PIN_RELAY_RIGHTGARAGE_DOOR   8
#define PIN_CONTACT_LEFTGARAGE_DOOR  9
#define PIN_CONTACT_RIGHTGARAGE_DOOR 10
#define PIN_CONTACT_FRONTGARAGE_DOOR 11

//House Door Pins

#define PIN_CONTACT_BASEMENT_DOOR     12
...
st::IS_DoorControl sensor5("frontDoor", PIN_CONTACT_FRONTGARAGE_DOOR, LOW, true, PIN_RELAY_FRONTGARAGE_DOOR, LOW, true, 1000);
...
st::IS_Contact sensor8("basementDoor", PIN_CONTACT_BASEMENT_DOOR, LOW, true);
